...
// kac adet veri oldugunu tutan degisken
int kn=0;

// yeni veri eklenir, ilk veri ise kesinlikle bu fonk. çalışır.
void ekle(){
	...
	if(kn==0){
		...
		// kisinin kac adet teli varsa eklenir
		while(1){
	...
	// ilk veri degilse ve sıralı ekleme degilse eklerken bu şart bloguna girilir.
	else{
...
// tüm kisler ve telefonlar listelenir
void listele(){
...
// kisi adi eslesen herkezi siler.
...
// istenilen ada sahip bireyleri listeler.
int araaa(char *ara){
...
// istenilen tele sahip herkezi listeler
...
// kucuk olan node, buyuk olan node ile degistirir.
...
// sıralı eklemede uygun olan yer bulunur, yeni veri olusturulur ve bu veri geri döndürülür
...
// ilk önce tüm veriler siralanir, daha sonra isme göre uygun konuma yerlestirilir.
void sirali_ekle(){
